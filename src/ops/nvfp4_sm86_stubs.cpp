...
void nvfp4_linear_swiglu_w4a4_launch_shard(const Tensor&, const Weight&, Tensor&, DeviceArena&,
                                           cudaStream_t) {
    reject_nvfp4_a4();
}
...
void nvfp4_attn_input_w4a4_launch_shard(const Tensor&, const Weight&, Tensor&, Tensor&, Tensor&,
                                        Tensor&, Nvfp4W4a4Workspace, cudaStream_t) {
    reject_nvfp4_a4();
}
